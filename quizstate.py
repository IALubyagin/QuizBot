# quizstate.py
# SQL запросы к служебной таблице SqlLite с помощью асинхронных вызовов.
# В настоящей версии для выполнения каждого запроса соединение открывается и закрывается
# контекстным менеджером.
# Реализация пула соединений или одного постоянного соединения ожидается в классе database.Database (см.)
